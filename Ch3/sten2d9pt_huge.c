...
void
stencil9pt_sstores(REAL *finp, REAL *foutp, 
...
int main(int argc, char *argv[]) 
{
  ...
  REAL *fa = (REAL *)mmap(0,WIDTHP*HEIGHT*sizeof(REAL),
                          PROT_READ|PROT_WRITE,
                          MAP_ANONYMOUS|MAP_PRIVATE|MAP_HUGETLB,-1,0);
  REAL *fb = (REAL *)mmap(0,WIDTHP*HEIGHT*sizeof(REAL),
                          PROT_READ|PROT_WRITE,
                          MAP_ANONYMOUS|MAP_PRIVATE|MAP_HUGETLB,-1,0);
  REAL   time  = 0.0;
  int    count = 1000;  
...
#pragma omp master
  printf("Initializing..%d Threads, %d x %d, PAD=%d..\n\n",
         omp_get_num_threads(),WIDTH, HEIGHT, (int) WIDTHP);
  ...
  stencil9pt_sstores(fin, fout, width, height, 
